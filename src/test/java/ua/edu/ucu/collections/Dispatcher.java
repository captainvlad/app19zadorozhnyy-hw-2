...
public class Dispatcher{
    ...
    public static void main(String[] args) {
        Object[] sample_1 = {1, "string", 'a', null};
        ImmutableArrayList example_1 = new ImmutableArrayList();
        ImmutableArrayList example_2 = new ImmutableArrayList();
        ImmutableArrayList example_3 = new ImmutableArrayList(sample_1);
        System.out.println(example_3.indexOf(null));
    }
}